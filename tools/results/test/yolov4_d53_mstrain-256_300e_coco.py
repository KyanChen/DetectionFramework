...
model = dict(
    type='YOLOV4',
    backbone=dict(type='YOLOV4Backbone'),
    neck=dict(
        type='YOLOV4Neck',
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/Users/kyanchen/Code/mmdetection/data/multi_label/../data_test.json',
        img_prefix='/Users/kyanchen/Code/mmdetection/data/multi_label',
        classes=['1', '2', '3'],
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(type='LoadAnnotations', with_bbox=True),
