...
def main():
    ...
    parser.add_argument('--result', default='../../data', help='result file (json format) path')
    parser.add_argument('--out_dir', default='../../data',  help='dir to save analyze result images')
    parser.add_argument(
        '--ann',
        default='../../data/data_test.json',
